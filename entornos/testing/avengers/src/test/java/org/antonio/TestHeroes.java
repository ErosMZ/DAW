...
public class TestHeroes {
    ...
    public void TestlistaHeroesPorSuperpoder(){
        ...
        Heroe blackphanther= new Heroe("black Panther", "trepa y araña", "e un makina", "paco");
        GestorHeroes gh2 = new GestorHeroes();
        gh2.agregarHeroe(uwu);
        gh2.agregarHeroe(blackphanther);
        List<Heroe> HeroesConSuperpoder = new ArrayList<>();
        HeroesConSuperpoder.add(uwu);
        HeroesConSuperpoder.add(blackphanther);
        

        assertArrayEquals(HeroesConSuperpoder.toArray(), gh2.listaHeroesPorSuperpoder("trepa y araña").toArray());
    }
